...
// DUNE-VD Gaisser-Hillas
  ...
  const double fGHVUVPars[4][9] = { {0.963643, 0.943959, 0.914075, 0.87, 0.81, 0.69, 0.56, 0.38, 0.25},
                                    {317.463, 332.442, 356.188, 405.763, 491.663, 598.814, 600, 680, 700},
                                    {353.659, 361.063, 362.83, 400, 400, 520, 600, 950, 350},
                                    {-500, -500, -500, -800, -800, -500, -500, -500, -500}};
                                    //{-275, -250, -200, -200, -150, -100, -75, -75, -50}
  const std::vector<double> slopes1 = {0.000204814, 0.000217372, 0.000193874, -4.33681e-18, 1.96241e-17, 5.09575e-18, -1.39862e-17, -9.6494e-18, 6.61363e-18};
  const std::vector<double> slopes2 = {0.0821847, 0.0808609, 0.0433978, -0.0168388, -0.104804, -0.154258, 8.28226e-14, -1.37224e-13, 1.57208e-13};  
  const std::vector<double> slopes3 = {-0.0140673, -0.0420794, -0.0487961, 3.30846e-14, 3.30846e-14, -1.41998e-13, 1.70641e-13, 2.33813e-13, -8.54317e-14}; 
