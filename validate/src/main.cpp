...
// DUNE-VD Gaisser-Hillas
  ...
  const double fGHVUVPars[4][9] = { {0.943912, 0.926578, 0.889993, 0.819655, 0.736, 0.634237, 0.52534, 0.398837, 0.304306},
                                    {147.373, 152.267, 150.884, 151.341, 162.121, 178.287, 185.604, 176.824, 142.23},
                                    {60.7412, 92.6295, 152.982, 174.853, 248.73, 270.913, 299.326, 313.677, 313.444},
                                    {-1800, -1000, -500, -500, -250, -200, -150, -150, -50}};

                                    //{-275, -250, -200, -200, -150, -100, -75, -75, -50}
  const std::vector<double> slopes1 = {0.000457871, 0.000447554, 0.000414071, 0.000371905, 0.000338113, 0.000293202, 0.000241719, 0.000186158, 0.000141449};
  const std::vector<double> slopes2 = {0.0689911, 0.0586803, 0.0619623, 0.0723533, 0.0507645, 0.0369949, 0.0313765, 0.0212458, 0.0352688};
  const std::vector<double> slopes3 = {-0.0261406, -0.0320543, -0.0537408, -0.076009, -0.103466, -0.116779, -0.138763, -0.140059, -0.128534};
  // double_sided
