...
// DUNE-VD Gaisser-Hillas
  ...
  const double fGHVUVPars[4][9] = { {1.03477, 0.993843, 0.97344, 0.917176, 0.858696, 0.762651, 0.659749, 0.515437, 0.388264},
                                    {149.431, 155.724, 165.776, 227.3, 256.61, 240.559, 274.63, 267.546, 277.366},
                                    {262.311, 293.53, 341.26, 417.618, 355.517, 349.998, 349.992, 364.323, 350.001},
                                    {-275, -250, -200, -200, -150, -100, -75, -75, -50}};
  const std::vector<double> slopes1 = {0.000409916, 0.000543992, 0.000294944, 0.000191344, 9.46113e-06, -3.85147e-05, -0.000106116, -8.74714e-05, -4.51208e-05};
  const std::vector<double> slopes2 = {0.112296, 0.055883, 0.0192164, -0.164962, -0.273601, -0.127058, -0.201171, -0.139522, -0.11314};
  const std::vector<double> slopes3 = {-0.323485, -0.474374, -0.367478, -0.533081, -0.0525134, -7.57024e-06, 1.92197e-05, -0.102837, -4.62003e-05};

  // // Var name is called double_sided, but is NOT, for DUNE FD1 HD 1x2x6 modded geometry (CPA side PDs)
  const double fGHVUVPars_double_sided[4][9] = { {1.03477, 0.993843, 0.97344, 0.917176, 0.858696, 0.762651, 0.659749, 0.515437, 0.388264},
                                                 {149.431, 155.724, 165.776, 227.3, 256.61, 240.559, 274.63, 267.546, 277.366},
                                                 {262.311, 293.53, 341.26, 417.618, 355.517, 349.998, 349.992, 364.323, 350.001},
                                                 {-275, -250, -200, -200, -150, -100, -75, -75, -50}};
  const std::vector<double> slopes1_double_sided = {0.000409916, 0.000543992, 0.000294944, 0.000191344, 9.46113e-06, -3.85147e-05, -0.000106116, -8.74714e-05, -4.51208e-05};
  const std::vector<double> slopes2_double_sided = {0.112296, 0.055883, 0.0192164, -0.164962, -0.273601, -0.127058, -0.201171, -0.139522, -0.11314};
  const std::vector<double> slopes3_double_sided = {-0.323485, -0.474374, -0.367478, -0.533081, -0.0525134, -7.57024e-06, 1.92197e-05, -0.102837, -4.62003e-05};

  // laterals
  const double fGHVUVPars_lateral[4][9] = { {1.03477, 0.993843, 0.97344, 0.917176, 0.858696, 0.762651, 0.659749, 0.515437, 0.388264},
                                            {149.431, 155.724, 165.776, 227.3, 256.61, 240.559, 274.63, 267.546, 277.366},
                                            {262.311, 293.53, 341.26, 417.618, 355.517, 349.998, 349.992, 364.323, 350.001},
                                            {-275, -250, -200, -200, -150, -100, -75, -75, -50}};
  const std::vector<double> slopes1_lateral = {0.000409916, 0.000543992, 0.000294944, 0.000191344, 9.46113e-06, -3.85147e-05, -0.000106116, -8.74714e-05, -4.51208e-05};
  const std::vector<double> slopes2_lateral = {0.112296, 0.055883, 0.0192164, -0.164962, -0.273601, -0.127058, -0.201171, -0.139522, -0.11314};
  const std::vector<double> slopes3_lateral = {-0.323485, -0.474374, -0.367478, -0.533081, -0.0525134, -7.57024e-06, 1.92197e-05, -0.102837, -4.62003e-05};
