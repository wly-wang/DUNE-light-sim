...
// DUNE-VD Gaisser-Hillas
  ...
  const double fGHVUVPars[4][9] = { {1.09983, 1.06816, 1.02604, 0.942545, 0.858583, 0.742254, 0.596959, 0.460682, 0.316655},
                                                 {116.374, 117.047, 116.3, 124.762, 130.846, 140.509, 158.183, 164.112, 184.342},
                                                 {116.591, 120.936, 132.785, 157.126, 144.118, 166.78, 198.78, 197.1, 183.591},
                                                 {-275, -250, -200, -200, -150, -100, -75, -75, -50}};
  const std::vector<double> slopes1 = {5.76428e-05, 7.89225e-05, 2.99393e-05, 2.39673e-06, -5.2952e-05, -5.34825e-05, 2.85777e-06, -4.96043e-05, -4.73768e-05};
  const std::vector<double> slopes2 = {-0.0712186, -0.0601303, -0.0465618, -0.0653745, -0.0661567, -0.0741761, -0.087313, -0.0401084, 0.00637255};
  const std::vector<double> slopes3 = {-0.127642, -0.116794, -0.106967, -0.118579, -0.0143361, 0.051726, 0.0043374, 0.00876357, 0.0664557};

  // protoDUNEhd double-sided.
  const double fGHVUVPars_double_sided[4][9] = { {1.38664, 1.34056, 1.28874, 1.25008, 1.11761, 0.993768, 0.837299, 0.684013, 0.557427},
                                                 {136.806, 131.533, 137.248, 145.334, 146.108, 156.314, 167.482, 180.47, 169.894},
                                                 {99.9184, 119.892, 120.003, 76.1228, 130.698, 134.38, 158.906, 143.403, 121.792},
                                                 {-275, -250, -200, -200, -150, -100, -75, -75, -50}};
  const std::vector<double> slopes1_double_sided = {-0.000330228, -0.000263596, -0.000267013, -0.000493081, -0.000369339, -0.000307718, -0.000230065, -0.000222268, -0.000269069};
  const std::vector<double> slopes2_double_sided = {-0.157152, -0.0989836, -0.11304, -0.10834, -0.0765906, -0.0635546, -0.0524302, -0.059102, 0.0096143};
  const std::vector<double> slopes3_double_sided = {0.00168278, -0.0782729, -0.0181855, 0.226885, 0.0470257, 0.0987078, 0.070141, 0.137596, 0.15385};

  // laterals
  const double fGHVUVPars_lateral[4][9] = { {0.823633, 0.798314, 0.718472, 0.667484, 0.558704, 0.452937, 0.32687, 0.298961, 0.157367},
                                    {32.3552, 50.3432, 90.8815, 80.6317, 106.951, 135.574, 176.201, 107.436, 162.605},
                                    {212.354, 213.01, 195.721, 199.999, 199.991, 199.999, 195.271, 200.055, 202.175},
                                    {-275, -250, -200, -200, -150, -100, -75, -75, -50} };
  const std::vector<double> slopes1_lateral = {-7.8508e-07, 6.59393e-06, 6.85063e-05, 6.98392e-06, -4.92025e-05, -2.67152e-05, -2.31886e-05, -6.52861e-05, -3.44846e-05};
  const std::vector<double> slopes2_lateral = {0.0202296, -0.000497866, -0.0624082, -0.0279447, 0.00653175, 0.00370553, 0.000465712, 0.0544498, 0.0581236};
  const std::vector<double> slopes3_lateral = {-0.0578599, -0.0538811, 0.0052102, -1.86132e-06, 9.83518e-06, -2.22772e-06, 0.00511375, -0.000161242, -0.00874451};
